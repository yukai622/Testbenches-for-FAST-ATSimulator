...
void debug_print_block(block_model_t *model)
{
	...
	fprintf(stdout, "Printing matrix b(CONDUCTANCE):\n");
	dump_dmatrix(model->b, model->n_nodes, model->n_nodes);
	fprintf(stdout, "Finish printing matrix b!\n");
	fprintf(stdout,"\n");
	//fprintf(stdout, "printing matrix g:\n");
	//dump_dmatrix(model->g, model->n_nodes, model->n_nodes);
	//fprintf(stdout, "finish printing matrix g!\n");
	//fprintf(stdout,"\n");
	fprintf(stdout, "Printing vector a(CAPACITANCE):\n");
	...
	fprintf(stdout, "Printing vector g_amb(ALL NODES CONVECT TO AMBIENT):\n");
